<template>
  ...
  >
    <nav class="fixed top-0 z-50 flex w-full items-center justify-between px-10 py-6 mix-blend-difference">
      <NuxtLink to="/" class="font-headline text-2xl font-extrabold uppercase italic tracking-tighter text-white">
        M. Barella
      </NuxtLink>
      <div class="hidden items-center gap-8 text-[10px] font-bold uppercase tracking-[0.2em] text-white md:flex">
        ...
        <a
          class="bg-white px-4 py-2 text-black transition-all hover:bg-[#00f2ff]"
    ...
    <header class="relative flex min-h-screen flex-col justify-center overflow-hidden px-10 pt-20">
      ...
      <div class="relative z-10 mx-auto w-full max-w-7xl">
        ...
        <h1 class="font-headline mb-8 text-[10vw] font-extrabold uppercase leading-[0.85] tracking-tighter">
          Digital<br />
        ...
        <div class="showcase-custom-grid items-end gap-12">
          ...
          <div class="group relative col-span-12 mt-12 md:col-span-7 md:mt-0">
            <div
              class="showcase-rotate-pos-1-soft absolute -inset-4 -z-10 border border-white/10 transition-transform duration-700 group-hover:rotate-0"
            />
            <div class="showcase-skew-1-soft relative aspect-video overflow-hidden border border-white/20 bg-white/5">
              <img
    ...
    <main class="relative py-20">
      <section class="mb-64 px-10">
        <div class="showcase-custom-grid mx-auto max-w-7xl gap-0">
          ...
          <div class="col-span-12 md:col-span-8 md:col-start-5 md:-mt-32">
            <div class="showcase-rotate-pos-1-soft relative aspect-video overflow-hidden bg-[#f8f6f3] shadow-2xl">
              <img
                ...
                decoding="async"
              >
              <div class="pointer-events-none absolute inset-0 border-[20px] border-[#0a0b10]/50" />
            </div>
          </div>
        </div>
      </section>

      <section class="relative mb-64 px-10">
        ...
        <div class="relative mx-auto max-w-7xl">
          <div class="showcase-custom-grid items-center gap-12">
            ...
            <div class="order-1 col-span-12 md:order-2 md:col-span-6 md:col-start-7">
              <h2 class="font-headline mb-12 text-7xl font-black uppercase tracking-tighter mix-blend-difference md:text-8xl">
                Actionable<br /><span class="text-[#00f2ff]">Logic.</span>
              </h2>
        ...
        <div class="mx-auto max-w-7xl px-10">
          <div class="mb-24 flex flex-col items-end justify-between md:flex-row">
            <div>
              ...
              <h2 class="font-headline mt-4 text-7xl font-black uppercase md:text-8xl">
                Precise<br />Delivery.
              </h2>
            </div>
